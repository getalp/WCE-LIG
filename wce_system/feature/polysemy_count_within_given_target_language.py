...
from feature.polysemy_count_common import convert_format_treetagger_to_format_babelnet, feature_polysemy_count_language, filter_number_of_polysemy, feature_polysemy_count_language_threads, convert_format_treetagger_to_format_dbnary, feature_polysemy_count_language_dbnary
...
def get_polysemy_count_within_given_target_language_threads(current_config, config_end_user, target_language, file_input_path, file_output_path, nthread, extension = ""):
    ...
    filter_number_of_polysemy(file_output_from_babel_net_temp_path, file_output_path)
#**************************************************************************#
def get_polysemy_count_within_given_target_language_with_dbnary(target_language, file_input_path, file_output_path, extension = ""):
    #spanish_language = current_config.LANGUAGE_SPANISH # Spanish, es
    #english_language = current_config.LANGUAGE_ENGLISH # English, en
    #french_language = current_config.LANGUAGE_FRENCH # French, fr
    current_config = load_configuration()
    ...
    #convert_format_treetagger_to_format_babelnet(current_config.BABEL_NET_INPUT_CORPUS_ES,dict_tagset_spanish,current_config.BABEL_NET_CORPUS_ES)
    #convert_format_treetagger_to_format_babelnet( current_config.TARGET_REF_TEST_OUTPUT_TREETAGGER_FORMAT_COL, dict_tagset_spanish, current_config.BABEL_NET_CORPUS_ES + "_" + server_name)
    file_babel_net_corpus_temp_path = current_config.DBNARY_CORPUS + extension
    convert_format_treetagger_to_format_dbnary( file_output_path_pattern_include_server_name, file_babel_net_corpus_temp_path, config_end_user)
    #convert_format_treetagger_to_format_babelnet( file_output_path_pattern_include_server_name, dict_tagset, file_babel_net_corpus_temp_path)
    feature_polysemy_count_language_dbnary( file_babel_net_corpus_temp_path, target_language, file_output_path, config_end_user)
...
def get_polysemy_count_within_given_target_language_with_dbnary_threads(current_config, config_end_user, target_language, file_input_path, file_output_path, nthread, extension = ""):
    #spanish_language = current_config.LANGUAGE_SPANISH # Spanish, es
    #english_language = current_config.LANGUAGE_ENGLISH # English, en
    #french_language = current_config.LANGUAGE_FRENCH # French, fr
    #current_config = load_configuration()
    ...
    file_babel_net_corpus_temp_path = current_config.DBNARY_CORPUS + "." + str(nthread) + extension
    #print("temp file : " + file_babel_net_corpus_temp_path)
    #convert_format_treetagger_to_format_babelnet( file_output_path_pattern_include_server_name, dict_tagset, file_babel_net_corpus_temp_path)
    convert_format_treetagger_to_format_dbnary( file_output_path_pattern_include_server_name, file_babel_net_corpus_temp_path, config_end_user)
    #convert_format_treetagger_to_format_babelnet( file_output_path_pattern_include_server_name, dict_tagset, file_babel_net_corpus_temp_path)
