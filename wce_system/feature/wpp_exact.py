...
"""
#**************************************************************************#
#Buoc trung gian: dung de chuyen nhung cau voi format "#weighted overall score|||hypothesis sentence"
#thanh list cac object Word_Position_Probability
...
def feature_wpp_exact(file_input_path, file_output_path):
    ...
    while current_number_of_phrase < number_of_sentences:
        ...
        #print("file name & path: BEGIN")
        #print(file_name_path)
        #print("file name & path: END")
