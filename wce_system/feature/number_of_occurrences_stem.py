...
#**************************************************************************#
def feature_number_of_occurrences_stem(file_input_path, file_output_path):
    """
    ...
    while line:
        ...
        while len(line) > 0:#if empty line #line in ('\n', '\r\n')
            ...
            str_UNK = "<UNK>"
            if line == str_UNK:
                stemmed_word = values_cols[0] #stemmed word, get value at index=2
            else:
            """
        ...
        #Calculating frequency of stemmed word in the sentence
...
if __name__ == "__main__":
    #Test case:
    #feature_number_of_occurrences_stem(file_input_path, file_output_path)
    #feature_number_of_occurrences_stem('../corpus/corpus.lc.en.column.pos.stem.txt','../extracted_features/corpus.lc.en.column.feature_number_of_occurrences_stem.txt')
    ...
    print('output')
    print(current_config.NUMBER_OF_OCCURRENCES_STEM)

    #feature_number_of_occurrences_stem(current_config.POS_STEM_CORPUS, current_config.NUMBER_OF_OCCURRENCES_STEM)
