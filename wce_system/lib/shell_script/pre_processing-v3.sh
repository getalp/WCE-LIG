...
if [ $1 == "fr" ]
then   
        sed -e "s/\([[:alpha:]]*\)\-t\-\([[:alpha:]]*\)/ \2 \1/g" $2 | perl normalize-punctuation.perl $1 | perl tokenizer.perl -l $1 | perl lowercase.perl | perl deescape-special-chars.perl | perl deescape-special-chars.perl > $3
else   
        perl normalize-punctuation.perl $1 < $2 | perl tokenizer.perl -l $1 | perl lowercase.perl | perl deescape-special-chars.perl | perl deescape-special-chars.perl > $3
fi
